...
void setup() {
  ...
  display.println("MPU6050 diplay is ready!");
  display.display();
}
...
void loop() {
  ...
  display.print(" | PDef: ");  display.print(pitchDeflect);
  display.print("  | RDef: ");  display.println(rollDeflect);
  display.display();
